...
assert(vm.runInContext("['warrior', 'mage', 'rogue'].every((id) => classCatalog[id] && Object.keys(classCatalog[id].buildAbilities).length === 3)", context), "playable classes should ship with three build paths");
