...
assert(vm.runInContext("(() => { state = defaultState(); state.hp = 1; applyActionCombatLoss({ enemy: enemies.wolf, enemyName: 'Waldwolf' }); return state.hp === state.maxHp; })()", context), "combat defeat should restore the player to full health after penalties");
