...
assert(vm.runInContext("(() => { state = defaultState(); selectedBestiaryType = 'dungeon'; selectedBestiaryZone = 'crypt'; selectedBestiaryEnemy = 'ratguard'; const bestiaryHtml = renderBestiaryList(); return bestiaryHtml.includes('bestiary-section-summary') && bestiaryHtml.includes('Erste Siege') && bestiaryHtml.includes('Feste Drops'); })()", context), "bestiary dungeon tab should summarize boss progress");
