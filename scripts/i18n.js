...
const translations = {
    de: {
        ...
        "classBuild.rogue.tank.text": "Überlebt durch Ausweichen und Blendtricks.",
        "classBuild.rogue.damage.text": "Sehr hohe Crit-Fenster und starke Finisher.",
        "classBuild.rogue.bruiser.text": "Kontert, heilt leicht und ignoriert Rüstung.",
        "classBuild.archer.tank.text": "Hält Abstand und kontrolliert Gegentreffer.",
        "classBuild.archer.damage.text": "Starke Schüsse und schnelle Salven.",
        "classBuild.archer.bruiser.text": "Jägerfokus mit Kontern und Rüstungsdruck.",
        ...
        "ability.heavyStrike.text": "Jede 3. Runde: 175% Schaden.",
        "ability.bladeFlurry.name": "Klingenserie",
        "ability.bladeFlurry.text": "Jede 4. Runde: ein zweiter Treffer mit 45% Schaden.",
        "ability.execute.name": "Hinrichten",
        "ability.execute.text": "Unter 30% Gegnerleben: 150% Schaden, höchstens alle 2 Runden.",
        "ability.shieldWall.name": "Schildwall",
        "ability.shieldWall.text": "Jede 4. Runde: nächster Gegentreffer -55%.",
        "ability.tauntingBlow.name": "Spottender Schlag",
        "ability.tauntingBlow.text": "Jede 3. Runde: Angriff und gegnerischer Schaden -25%.",
        "ability.lastStand.name": "Letztes Aufbäumen",
        "ability.lastStand.text": "Einmal unter 40% Leben: Heilung und kurze Schadensdämpfung.",
        "ability.battleRush.name": "Kampfrausch",
        "ability.battleRush.text": "Einmal unter 45% Leben: heilt 18% Leben.",
        "ability.shatter.name": "Zerschmettern",
        "ability.shatter.text": "Jede 3. Runde: 130% Schaden und ein Teil der Rüstung wird ignoriert.",
        "ability.counterBlow.name": "Konterschlag",
        "ability.counterBlow.text": "Nach hartem Treffer: Konter mit 50% Schaden, höchstens alle 3 Runden.",
        ...
        "ability.backstab.text": "Jede 3. Runde: 168% Schaden.",
        "ability.dualCut.name": "Doppelschnitt",
        "ability.dualCut.text": "Jede 4. Runde: ein zweiter Treffer mit 55% Schaden.",
        "ability.finisher.name": "Finaler Stich",
        "ability.finisher.text": "Unter 30% Gegnerleben: 160% Schaden, höchstens alle 2 Runden.",
        "ability.shadowVeil.name": "Schattenmantel",
        "ability.shadowVeil.text": "Jede 4. Runde: nächster Gegentreffer -55%.",
        "ability.blindside.name": "Blendwurf",
        "ability.blindside.text": "Jede 3. Runde: Treffer und gegnerischer Schaden -25%.",
        "ability.lastTrick.name": "Letzter Trick",
        "ability.lastTrick.text": "Einmal unter 40% Leben: Heilung und kurze Schadensdämpfung.",
        "ability.adrenaline.name": "Adrenalin",
        "ability.adrenaline.text": "Einmal unter 45% Leben: heilt 15% Leben.",
        "ability.armorPiercer.name": "Panzerstecher",
        "ability.armorPiercer.text": "Jede 3. Runde: 130% Schaden und ein Teil der Rüstung wird ignoriert.",
        "ability.riposte.name": "Riposte",
        "ability.riposte.text": "Nach hartem Treffer: Konter mit 60% Schaden, höchstens alle 3 Runden.",
        "ability.powerShot.name": "Kraftschuss",
        "ability.powerShot.text": "Jede 3. Runde: 172% Schaden.",
        "ability.rapidVolley.name": "Schnellfeuer",
        "ability.rapidVolley.text": "Jede 4. Runde: ein zweiter Treffer mit 50% Schaden.",
        "ability.heartpiercer.name": "Herzsucher",
        "ability.heartpiercer.text": "Unter 30% Gegnerleben: 155% Schaden, höchstens alle 2 Runden.",
        "ability.distanceGuard.name": "Distanzwache",
        "ability.distanceGuard.text": "Jede 4. Runde: nächster Gegentreffer -55%.",
        "ability.pinningShot.name": "Festnageln",
        "ability.pinningShot.text": "Jede 3. Runde: Treffer und gegnerischer Schaden -25%.",
        "ability.survivalInstinct.name": "Überlebensinstinkt",
        "ability.survivalInstinct.text": "Einmal unter 40% Leben: Heilung und kurze Schadensdämpfung.",
        "ability.hunterFocus.name": "Jägerfokus",
        "ability.hunterFocus.text": "Einmal unter 45% Leben: heilt 15% Leben.",
        "ability.piercingArrow.name": "Durchschlagspfeil",
        "ability.piercingArrow.text": "Jede 3. Runde: 130% Schaden und ein Teil der Rüstung wird ignoriert.",
        "ability.snapShot.name": "Reaktionsschuss",
        "ability.snapShot.text": "Nach hartem Treffer: Konter mit 55% Schaden, höchstens alle 3 Runden.",
